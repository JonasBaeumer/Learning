# SAME CODE AS BELOW JUST REMOVED UNECESSARY PARAMETERS FOR NESTED FUNCTION
...
class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def dfs(current_string, i, j):
            ...
            search_left = dfs(new_string, i, j+1)
            search_right = dfs(new_string, i, j-1)
            search_up = dfs(new_string, i-1, j)
            search_down = dfs(new_string, i+1, j)
